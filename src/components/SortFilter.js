...
function SortFilter() {
  ...
  useEffect(() => {
    ...
    if (genreList.length > 0) {
      genreList.map((item) => setChangeUrl(changeUrl.concat("&", item)));
    }
    setSearch(false);
    setDataSize(3);
  }, [changeUrl, endDate, genreList, search, sort, startDate]);
        ...
        <div className="container my-5">
          <div className="row">
                ...
                <ul class="list-group list-group-horizontal">
                  ...
                  >
                    <input
                      ...
                      id="start_date"
                      onChange={(e) =>
                        setStartDate(`release_date.gte=${e.target.value}`)
                      }
                    />
                  </li>
                </ul>
                <ul class="list-group list-group-horizontal">
                  ...
                  >
                    <input
                      ...
                      id="end_date"
                      onChange={(e) =>
                        setEndDate(`release_date.lte=${e.target.value}`)
                      }
                    />
                  </li>
                </ul>
            ...
            <div className="col-md-8 text-center">
              ...
              <button
                className={`btn ms-5 ${theme ? "btn-light" : "btn-dark"}`}
                onClick={showData}
              >
                Load More
              </button>
